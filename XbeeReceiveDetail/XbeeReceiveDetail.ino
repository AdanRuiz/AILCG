...
void handleXbeeRxMessage(uint8_t *data, uint8_t length){
    ...
    String firstParameter = myString.substring(0, commaIndex);
    int separatorIndex = myString.indexOf(':');
    String firstKey = myString.substring(0, separatorIndex);
    String firstValue = myString.substring(separatorIndex+1,commaIndex);
    Serial.print(firstKey);
    Serial.print('=');
    Serial.println(firstValue);
    if(firstKey.equals("XB") && firstValue.equals("1")){
        ...
        analogWrite(ledPin, pwmValue.toInt());
    }
